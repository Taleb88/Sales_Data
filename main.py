    ...
    try:
        ...
        for order_priority in order_priorities_list:
            try:
                ...
                united_states_of_america_holidays_order_priority.to_csv(f'new_csvs/united_states_of_america_holiday_order_priority_{order_priority}.csv',index=False)
                # develop dataframes per sales channel - online/offline
                united_states_of_america_holidays_order_priority_online = united_states_of_america_holidays_order_priority.loc[(united_states_of_america_holidays_order_priority['Sales Channel'] == 'Online') & 
                                                                                                                               (united_states_of_america_holidays_order_priority['Order Priority'] == order_priority)]
                united_states_of_america_holidays_order_priority_online.to_csv(f'new_csvs/united_states_of_america_holiday_order_priority_{order_priority}_online.csv',index=False)
                united_states_of_america_holidays_order_priority_offline = united_states_of_america_holidays_order_priority.loc[(united_states_of_america_holidays_order_priority['Sales Channel'] == 'Offline') & 
                                                                                                                                (united_states_of_america_holidays_order_priority['Order Priority'] == order_priority)]
                united_states_of_america_holidays_order_priority_offline.to_csv(f'new_csvs/united_states_of_america_holiday_order_priority_{order_priority}_offline.csv',index=False)
            except Exception as e:
